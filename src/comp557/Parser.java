...
//			BallXYZ joint = new BallXYZ( name );
			...
			if ( (t1=getTuple3dAttr(dataNode,"minlim")) != null  && (t2=getTuple3dAttr(dataNode,"maxlim")) != null) joint.setLimits(t1, t2);
			return joint;
...
//			Hinge joint = new Hinge( name );
	...
	public static DAGNode createGeom( Node dataNode ) {
		...
		if ( type.equals("box" ) ) {
			...
			BodyCone geom = new BodyCone( name );
			if ( (t=getTuple3dAttr(dataNode,"center")) != null ) geom.setCentre( t );
			if ( (t=getTuple3dAttr(dataNode,"scale")) != null ) geom.setScale( t );
			if ( (t=getTuple3dAttr(dataNode,"color")) != null ) geom.setColor( t );
			d=getDoubleAttr(dataNode,"rotation");  geom.setRotation( d );
			return geom;
		} else if ( type.equals("cylinder" ) ) {
			BodyCylinder geom = new BodyCylinder( name );
			if ( (t=getTuple3dAttr(dataNode,"center")) != null ) geom.setCentre( t );
			if ( (t=getTuple3dAttr(dataNode,"scale")) != null ) geom.setScale( t );
			if ( (t=getTuple3dAttr(dataNode,"color")) != null ) geom.setColor( t );
			return geom;
		} else if ( type.equals("rect") ) {
			BodyRect geom = new BodyRect( name );
			return geom;
		} else if ( type.equals("line") ) {
			BodyLine geom = new BodyLine( name );
			return geom;
		}
		return null;		 
	}
